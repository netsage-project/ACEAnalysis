...
# similar to top institutions, this provides top 20 with details.
...
fileName1="C:/Users/Abhi/Desktop/y2q2/AfricanCountireswithDetailsALL-result-Top20DestOrg.txt"

topCount=0
with open(fileName1, "w") as myfile:
        myfile.write("Top 20 Talkers in Africa based on Destination Institutions in ACE traffic from March-1-2016 to November-30-2016 ")
        #myfile.write("Top 20 Talkers in US based on Institution in ACE traffic from March-1-2016 to November-30-2016 ")
        myfile.write("\n")
        myfile.write("\n")
        myfile.write("\n")
        myfile.write("----------------------------------------"+"\n")
